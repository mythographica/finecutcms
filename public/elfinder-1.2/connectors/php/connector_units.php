...
include_once dirname( dirname( dirname( dirname(__FILE__) ) ) ).DIRECTORY_SEPARATOR.'settings.php';

$opts = array( 
	'root'            => '../../../../units/',         // path to root directory
	'URL'             => '../units/', 		// root directory URL
	...
	'fileMode'     => $perm_file,      // new files mode
	'dirMode'      => $perm_folder,    // new folders mode
